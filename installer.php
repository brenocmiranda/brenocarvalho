...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20220920_brenodecarvalho_8e8a975a7f1c8d885085_20221216193343_archive.zip';
        const ARCHIVE_SIZE       = '84066161';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '8e8a975-16193343';
        const SECONDARY_PACKAGE_HASH = '36123e1-16193343';
        const VERSION            = '1.5.1';
